    ...
    <div id="app">
        ...
        <div id="container">
            ...
            <table>
                <tr>
                    <th>(대표자)이름</th>
                    <td><input type="text" v-model="userName" placeholder="가입시 입력한 이름/대표자명"></td>
            ...
            <button class="login-btn" @click="fnFindId()">아이디 찾기</button>
            <div class="link-wrap">
                <a href="/login.do"><span>로그인 페이지로 돌아가기</span></a>
                <span>|</span>
                <a href="/find-pwd.do"><span>비밀번호 찾기</span></a>
            </div>
        </div>
    </div>
</body>
