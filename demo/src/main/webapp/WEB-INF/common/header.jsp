...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleTabClick() {
        ...
        if (menuParam) {
            ...
            <nav class="navbar navbar-expand-lg sticky-top bg-white shadow-sm dropdown-header-wrap"
                style="border-bottom: 2px solid #fff0f3 !important;">
                <div class="container">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/merryViewHome.do"
                        style="text-decoration:none!important; display:flex; align-items:center; gap:10px;">
                        <img src="${pageContext.request.contextPath}/css/marryview-logo.svg" alt="MARRY VIEW"
                            style="height:32px; width:auto;">
                        <span
                            style="font-family:'Playfair Display',Georgia,serif; font-size:22px; font-weight:700; color:#ff4d6d; letter-spacing:0.5px;">MarryView</span>
                    </a>
                        ...
                        <ul class="navbar-nav ml-auto" style="align-items: center; overflow: visible !important;">
                            <li class="nav-item has-dropdown">
                                <a class="nav-link custom-nav-link"
                                    href="${pageContext.request.contextPath}/about.do">회사소개 </a>
                                <ul class="dropdown-contents">
                                    <li><a href="/about.do">메리뷰 소개</a></li>
                                    <li><a href="/location.do">찾아오시는 길</a></li>
                                    <li><a href="/history.do">회사 연혁</a></li>
                            ...
                            <li class="nav-item has-dropdown">
                                <a class="nav-link custom-nav-link"
                                    href="${pageContext.request.contextPath}/productCategoryTag.do">상품목록</a>
                                <ul class="dropdown-contents">
                                    <li><a href="${pageContext.request.contextPath}/productCategoryTag.do">상품 찾기</a>
                                    </li>
                                    <li><a href="/partner.do">입점 문의</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item has-dropdown">
                                <a class="nav-link custom-nav-link"
                                    href="${pageContext.request.contextPath}/api/community/list.do">커뮤니티</a>
                                <ul class="dropdown-contents">
                                    <li><a href="${pageContext.request.contextPath}/api/community/list.do">전체 보기</a>
                                    </li>
                                    <li><a
                                            href="${pageContext.request.contextPath}/api/community/list.do?category=자유">자유글</a>
                                    </li>
                                    <li><a
                                            href="${pageContext.request.contextPath}/api/community/list.do?category=질문">질문글</a>
                                    </li>
                                    <li><a
                                            href="${pageContext.request.contextPath}/api/community/list.do?category=정보">정보공유글</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item has-dropdown">
                                <a class="nav-link custom-nav-link"
                                    href="${pageContext.request.contextPath}/api/review/list.do">리얼리뷰</a>
                                <ul class="dropdown-contents">
                                    <li><a href="${pageContext.request.contextPath}/api/review/list.do">전체보기</a></li>
                                    <li><a href="${pageContext.request.contextPath}/api/review/list.do?isPaid=1">💎 유료
                                            리뷰</a></li>
                                    <li><a href="${pageContext.request.contextPath}/api/review/list.do?isPaid=0">🎁 무료
                                            리뷰</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item has-dropdown">
                                <a class="nav-link custom-nav-link"
                                    href="${pageContext.request.contextPath}/adminPass.do">패스구매</a>
                                <ul class="dropdown-contents">
                                    <li><a href="${pageContext.request.contextPath}/adminPass.do">패스상품보기</a></li>
                                    <li><a href="${pageContext.request.contextPath}/adminMyPass.do">내 패스 조회</a></li>
                                </ul>
                                ...
                                <c:choose>
                                    <%-- 1. 로그인 상태 확인 --%>
                                        <c:when test="${not empty sessionScope.sessionId}">
                                            <c:choose>
                                                <%-- 2. 일반 사용자(USER)인 경우만 드롭다운 메뉴 포함 --%>
                                                    <c:when test="${sessionScope.sessionRole == 'USER'}">
                                                        <a class="nav-link custom-nav-link"
                                                            href="${pageContext.request.contextPath}/userMyPage.do">마이페이지</a>
                                                        <ul class="dropdown-contents">
                                                            <li><a
                                                                    href="${pageContext.request.contextPath}/userMyPage.do">마이페이지
                                                                    홈</a></li>
                                                            <li><a
                                                                    href="${pageContext.request.contextPath}/userMyPage-pay.do">결제
                                                                    멤버십 내역</a></li>
                                                            <li><a
                                                                    href="${pageContext.request.contextPath}/userMyPage-review.do">리뷰
                                                                    열람 내역</a></li>
                                                            <li><a
                                                                    href="${pageContext.request.contextPath}/userMyPage-write.do">내가
                                                                    쓴 글/리뷰/댓글</a></li>
                                                            <li><a
                                                                    href="${pageContext.request.contextPath}/userMyPage-like.do">좋아요
                                                                    목록</a></li>
                                                            <li><a
                                                                    href="${pageContext.request.contextPath}/userMyPage-cs.do">내
                                                                    문의/신고 내역</a></li>
                                                        </ul>
                                                    </c:when>
                                                    ...
                                                    <%-- 3. 파트너/관리자 등은 드롭다운 없이 단일 링크로 유지 --%>
                                                        <c:when
                                                            test="${sessionScope.sessionRole == 'PARTNER' or sessionScope.sessionRole == 'NPARTNER'}">
                                                            <a class="nav-link custom-nav-link"
                                                                href="javascript:void(0)">업체페이지</a>
                                                            <ul class="dropdown-contents">
                                                                <li><a
                                                                        href="${pageContext.request.contextPath}/partnerManagement.do">업체페이지
                                                                        홈</a></li>
                                                                <li><a
                                                                        href="${pageContext.request.contextPath}/partnerManagement.do?menu=product">상품
                                                                        관리</a></li>
                                                                <li><a
                                                                        href="${pageContext.request.contextPath}/partnerManagement.do?menu=reservation">예약
                                                                        관리</a></li>
                                                                <li><a
                                                                        href="${pageContext.request.contextPath}/partnerManagement.do?menu=inquiry">문의
                                                                        내역</a></li>
                                                                <li><a
                                                                        href="${pageContext.request.contextPath}/partnerManagement.do?menu=review">리뷰
                                                                        내역</a></li>
                                                            </ul>
                                                        </c:when>
                                                        <c:when test="${sessionScope.sessionRole == 'ADMIN'}">
                                                            <a class="nav-link custom-nav-link"
                                                                href="${pageContext.request.contextPath}/adminMain.do">관리자페이지
                                                                <i class="fas fa-chevron-right arrow-icon"></i></a>
                                                            <ul class="dropdown-contents">
                                                                <li style="display: flex; align-items: center"><a
                                                                        href="${pageContext.request.contextPath}/adminMain.do">관리자</a>
                                                                    / <a
                                                                        href="${pageContext.request.contextPath}/adminStatistics.do">통계</a>
                                                                </li>
                                                                <li style="display: flex; align-items: center"><a
                                                                ...
                                                                <li style="display: flex; align-items: center"><a
                                                                        href="${pageContext.request.contextPath}/adminBoard.do">게시판</a>
                                                                    / <a
                                        ...
                                        <%-- 4. 비로그인 상태일 때 --%>
                                            <c:otherwise>
                                                <a class="nav-link custom-nav-link"
                                                    href="${pageContext.request.contextPath}/login.do">마이페이지 <i
                                                        class="fas fa-chevron-right arrow-icon"></i></a>
                                            </c:otherwise>
                                </c:choose>
                            </li>
                                ...
                                <c:choose>
                                    <c:when test="${empty sessionScope.sessionId}">
                                        <a class="nav-link" href="${pageContext.request.contextPath}/login.do"
                                            ...
                                            <i class="fas fa-user-circle" style="font-size: 1.3rem !important;"></i>
                                            <span
                                                style="font-size: 0.95rem; font-weight: bold; margin-left: 4px;">로그인</span>
                                        </a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="nav-link" href="${pageContext.request.contextPath}/logout.do"
                                            title="로그아웃" style="color: #ff4d6d !important; padding: 0 10px !important;">
                                            <i class="fas fa-sign-out-alt" style="font-size: 1.3rem !important;"></i>
                                        </a>
                                    </c:otherwise>
                                </c:choose>
