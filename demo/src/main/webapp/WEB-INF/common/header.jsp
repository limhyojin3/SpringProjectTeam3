                        ...
                        <c:when test="${not empty sessionScope.sessionId}">
                            <c:choose>
                                ...
                                <c:when test="${sessionScope.sessionRole == 'ADMIN'}">
                                    <a class="nav-link custom-nav-link" href="javascript:void(0)">관리자페이지 <i class="fas fa-chevron-right arrow-icon"></i></a>
                                    <ul class="dropdown-contents">
                                        <li><a href="${pageContext.request.contextPath}/adminMain.do">관리자 홈</a></li>
                                        <!-- <li><a href="${pageContext.request.contextPath}/adminUser.do">회원 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminCompany.do">업체 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminBoard.do">게시판 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminReview.do">리뷰 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminPayment.do">결제 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminProduct.do">상품 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminReport.do">신고 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminInquiry.do">문의 관리</a></li>
                                        <li><a href="${pageContext.request.contextPath}/adminStatistics.do">통계</a></li> -->
                                    </ul>
                                </c:when>
                            </c:choose>
                        </c:when>
