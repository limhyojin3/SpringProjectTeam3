<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                            ...
                            <div class="pay-finish-box">
                                ...
                                <div class="info-box">
                                    ...
                                    <div class="info-row">
                                        ...
                                        <span class="info-value success">${payment.pay_status == "SUCCESS" ? "결제성공" :
                                            "결제실패"}</span>
                                    </div>
                                    ...
                                    <div class="info-row">
                                        ...
                                        <span class="info-value">
                                            ${fn:replace(fn:substring(payment.pay_date, 0, 16), 'T', ' ')}
                                        </span>
                                    </div>
                                ...
                                <div class="btn-area">
                                    <button class="btn btn-main"
                                        onclick="location.href='${pageContext.request.contextPath}/merryViewHome.do'">
                                        홈으로 이동
                                    </button>
            ...
            and (sessionScope.sessionRole eq 'NPARTNER'
            or sessionScope.sessionRole eq 'PARTNER')}">

                                                <button class="btn btn-sub"
                                                    onclick="location.href='${pageContext.request.contextPath}/partnerManagement.do'">
                                                    업체 페이지
                                                </button>
                                            </c:when>
                                            ...
                                            <%-- 예약 결제 --%>
                                                <c:when test="${type eq 'RES'}">
                                                    <button class="btn btn-sub"
                                                        onclick="location.href='${pageContext.request.contextPath}/myReservation.do'">
                                                        예약 목록
                                                    </button>
                                                </c:when>
                                                ...
                                                <%-- 패스권 결제 등 나머지 --%>
                                                    <c:otherwise>
                                                        <button class="btn btn-sub"
                                                            onclick="location.href='${pageContext.request.contextPath}/api/review/list.do'">
                                                            리뷰 게시판
                                                        </button>
                                                    </c:otherwise>
                                    </c:choose>
