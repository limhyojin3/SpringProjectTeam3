		...
		<div class="detail-container">
			...
			<div class="detail-right">
				...
				<div class="price-info-box">
					<div class="price-row">
						<span>예상 견적 :</span>
						<span>{{ product.price ? Number(String(product.price).replace(/[^0-9]/g, '')).toLocaleString() : 0 }}원</span>
					</div>
				</div>
				<div class="price-info-box">
					<div class="price-row">
						<span>예약금 :</span>
						<span>{{ product.deposit ? Number(String(product.deposit).replace(/[^0-9]/g, '')).toLocaleString() : 0 }}원</span>
					</div>
				</div>
