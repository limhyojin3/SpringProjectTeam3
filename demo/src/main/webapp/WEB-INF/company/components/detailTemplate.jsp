    ...
    <div>
        ...
        <div class="detail-container">
            <div class="detail-left">
                <img :src="productInfo.thumbnail" class="detail-main-img">
                <div class="detail-company-name">{{ productInfo.company }}</div>
                ...
                <div class="detail-description-card">
                    ...
                    <p>메리뷰는 웨딩업체의 상품을 중개합니다. 
                       ...
                       노쇼인 경우 예약금 환불은 원칙적으로 불가하며 피치못한 사정으로 노쇼하실 경우, 
                       불참 사유를 증명할 서류를 지참하시면 소비자보호원의 법적 사항을 준수하여 
                       업체 규정에 따라 검토 후 예약금 환불이 가능합니다.</p>
                </div>
            ...
            <div class="detail-right">
                ...
                <div class="price-info-box">
                    <div class="price-row">
                        <span>예상 견적 :</span>
                        <span>{{ Number(productInfo.price).toLocaleString() }}원</span>
                    </div>
                </div>
                <div class="price-info-box">
                    <div class="price-row">
                        <span>예약금 :</span>
                        <span>{{ Number(productInfo.deposit).toLocaleString() }}원</span>
                    </div>
                </div>
                
                <button class="btn-reserve" @click="handleReserve">예약하기</button>
                <button class="btn-inquiry" @click="handleInquiry">상품 문의하기</button>
            </div>
        </div>
    </div>
</template>