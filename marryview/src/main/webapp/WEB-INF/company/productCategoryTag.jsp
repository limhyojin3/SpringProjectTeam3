...
<head>
	...
	<title>MarryView - 상품 및 업체 찾기</title>
				...
				<main>
					<div v-if="currentMenu === 'main' && productPage === 'list'">
						<product-list-component 
							...
							:init-search-mode="currentSearchMode"
							@search-mode-change="val => currentSearchMode = val"
							@update-filter-list="fnLoadProductList"
							@go-detail="goDetailPage"
							@go-company-detail="goCompanyDetailPage"
...
<jsp:include page="/WEB-INF/company/components/companyDetailTemplate.jsp" />
